...
public class AI : MonoBehaviour
{
    ...
    [Task]
    public bool HasFledFromThePlayer()
    {
        return fleeStatus;
    }
    ...
    [Task]
    //Podría ir también en el estado de TakeCover...
    public void RegisterPlayerLastSeenPosition()
    {
    ...
    [Task]
    public void SetTargetDestinationToPlayerLastSeenPosition()
    {
